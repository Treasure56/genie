...
export default function PlaceCard({ place }: PlaceCardProps) {
  return (
    <div className="group bg-white dark:bg-slate-950 rounded-2xl p-3  duration-300 border border-gray-100 dark:border-slate-800 flex gap-4 transition-colors">
      ...
      <div className="flex flex-col flex-1 justify-between py-1">
        <div>
          <div className="flex justify-between items-start">
            <h3 className="font-bold text-slate-900 dark:text-slate-100 text-lg leading-tight line-clamp-1">
              {place?.name}
            </h3>
