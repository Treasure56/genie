...
export default function Forms() {
  return (
    <div className="app-container flex justify-center">
      <form className="bg-white dark:bg-slate-950 rounded-xl  border border-gray-100 dark:border-slate-800 p-2 flex flex-col md:flex-row items-center gap-2 w-full max-w-6xl transition-colors">
              ...
              <MultiSelectGroup className="text-gray-800 dark:text-slate-100">
                {interests.map((interest) => (
                  <MultiSelectItem
                    key={interest}
                    value={interest}
                    className="rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/30 cursor-pointer"
                  >
                    {interest}
                  </MultiSelectItem>
                ))}
